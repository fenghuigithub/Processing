...
int sensorPin =A0;
int sensorNumber = 0;   //initial the number of times for taping photosensor
int sensorValue;
...
//Every time the photosensor is coverred by my finger,
//the number on LCD will increase by one. 

 if (sensorValue > 64 && sensorValue < 80 ){
